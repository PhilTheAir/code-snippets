...
describe('GET /', function() {
  var expected = {
    error: 'Please POST me the data.'
  };
  
  it('should reponse GET with HTTP 400', function(done) {
    request(app)
      .get('/')
...
describe('POST /', function() {
  ...
  it('should respond valid POST json values', function(done) {
    request(app)
      .post('/')
      .send(params)
...
describe('POST /', function() {
  var params = 'errorJSON';
  var expected = { error: 'Could not decode request: JSON parsing failed' };
  it('should respond invalid POST json values with HTTP 400', function(done) {
    request(app)
      .post('/')
      .send(params)
      .expect(400, expected, done);
